  ...
  const wordLists = {
    easy: {
      ...
      space: [
        ...
        { word: 'earth', emoji: '🌍', definition: 'The planet we live on' },
        { word: 'mars', emoji: '🪐', definition: 'The red planet' },
        { word: 'jupiter', emoji: '🪐', definition: 'The biggest planet' },
        { word: 'saturn', emoji: '🪐', definition: 'A planet with beautiful rings' },
        { word: 'venus', emoji: '🪐', definition: 'A hot planet near the sun' },
        { word: 'mercury', emoji: '🪐', definition: 'The closest planet to the sun' },
        { word: 'rocket', emoji: '🚀', definition: 'A vehicle that flies to space' },
      ],
      food: [
        { word: 'apple', emoji: '🍎', definition: 'A red or green fruit' },
        { word: 'banana', emoji: '🍌', definition: 'A yellow curved fruit' },
        { word: 'orange', emoji: '🍊', definition: 'A round orange fruit' },
        { word: 'grape', emoji: '🍇', definition: 'Small purple or green fruits' },
        ...
        { word: 'cheese', emoji: '🧀', definition: 'Made from milk' },
        { word: 'potato', emoji: '🥔', definition: 'A brown vegetable' },
      ],
    },
    medium: {
      jungle: [
      ...
      space: [
        ...
        { word: 'alien', emoji: '👽', definition: 'A being from another planet' },
        { word: 'nebula', emoji: '🌌', definition: 'A colorful cloud of gas in space' },
        { word: 'crater', emoji: '🌑', definition: 'A big hole on the moon' },
      ],
      food: [
        ...
        { word: 'taco', emoji: '🌮', definition: 'A Mexican food with a shell' },
        { word: 'pasta', emoji: '🍝', definition: 'Noodles with sauce' },
        { word: 'cake', emoji: '🎂', definition: 'A sweet birthday treat' },
      ],
    },
    hard: {
      jungle: [
      ...
      space: [
        ...
        { word: 'milky way', emoji: '🌌', definition: 'Our galaxy with billions of stars' },
        { word: 'black hole', emoji: '⚫', definition: 'So dense that light cannot escape' },
        { word: 'supernova', emoji: '💥', definition: 'An exploding star in space' },
      ],
      food: [
        ...
        { word: 'recipe', emoji: '📝', definition: 'Instructions for cooking food' },
        { word: 'chef', emoji: '👨‍🍳', definition: 'A professional cook' },
        { word: 'dessert', emoji: '🍰', definition: 'The sweet course after dinner' },
      ],
    },
  }
